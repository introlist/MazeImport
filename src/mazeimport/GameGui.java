    ...
    public GameGui() throws IOException//JFrame
    {
       ...
       this.setContentPane(new JPanel() {
                BufferedImage image = ImageIO.read(
                        new URL("http://www.ew.com/sites/default/files/styles/tout_image_612x380/public/i/2013/05/08/maze-runner_612x380_0.jpg?itok=7443PS2O"));
...
private JButton newGameItem;
private JButton openFileItem;
